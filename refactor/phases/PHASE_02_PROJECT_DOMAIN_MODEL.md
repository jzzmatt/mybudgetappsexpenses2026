# Phase 02 — Project Domain Model

## Objective

Make Project the primary financial workspace. Establish mandatory Project budget/currency, required expense.project_id, inherited currency and centralized financial calculations. Add tests.
