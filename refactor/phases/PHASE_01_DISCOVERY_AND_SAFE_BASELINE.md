...
Baseline the existing repository without behavior changes. Map current routes, expense/project schema, navigation, storage, AI, reports and tests. Document migration risks and obsolete attachment assumptions.
