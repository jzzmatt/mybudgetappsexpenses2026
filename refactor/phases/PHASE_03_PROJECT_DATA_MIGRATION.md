...
Safely migrate existing data to Project-centric structure. Backfill Projects/expense.project_id, reconcile currencies, introduce payment-proof fields if needed, preserve RLS and evidence.
