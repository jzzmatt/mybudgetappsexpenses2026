# Phase 07 — Shared Categories And Vendors

## Objective

Make Categories and Vendors explicitly shared user-level resources. Preserve RLS, reuse across Projects, update selectors and keep management simple.
